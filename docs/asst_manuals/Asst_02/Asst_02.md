...
Add support for the following previously unsupported instructions/features. They are pretty easy to add at this point and will allow you to run almost all RV32I code (not: does not include M extension) generated by a compiler.
...
Do not forget to change the delays in your application program according to the clock frequency and interaction requirements.
