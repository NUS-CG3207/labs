...
* DMEM_DEPTH_BITS should also be changed as appropriate. However, if you need more memory (ROM+RAM) such as what you will need when you load images, change this. STACK_INIT and MMIO_BASE in your C source code should also be modified to correspond to this.
